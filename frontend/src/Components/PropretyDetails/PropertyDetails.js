      ...
      {propertyName && (
        <>
          ...
          <div className="middle-container row">
            <div className="des-and-amenities col-md-8 con-sm-12 col-12">
              <h2 className="property-description-header">DESCRIPTION</h2>
              <p className="property-description">
                {description} <br /> <br />
                Maximun number of guests : {maximumGuest}
              </p>
              <hr />
          ...
          <div className="property-map">
            <div className="map-image-exinfo-container row">
              <div className="map-image-container col-md-6 col-sm-3 col-12">
                <h2 className="map-header">Where you will be</h2>
                <MapComponent address={address}/>
              </div>
              <div className="extra-info col-md-6 col-sm-12 col-12">
                <h2 className="extra-heading">Extra Information</h2>
